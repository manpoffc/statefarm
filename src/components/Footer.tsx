...
<footer className="p-4 bg-white sm:p-6 dark:bg-gray-900">
    <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
            <h3 className="flex items-center">
                <img src="https://i.postimg.cc/rmfJrP28/cute-labrador-dog-sitting-cartoon-vector-icon-illustration-animal-nature-icon-concept-isolated-13867.png" className="mr-3 h-8" alt="FlowBite Logo" />
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">PawSome</span>
            </h3>
        </div>
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400">
                    <li className="mb-4">
                        <h3 className="hover:underline">PawSome</h3>
                    </li>
                    <li>
                        <h3  className="hover:underline">PawShop Coming Soon.....</h3>
                    </li>
                </ul>
            </div>
            <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400">
                    <li className="mb-4">
                        <h3 className="hover:underline ">Github</h3>
                    </li>
                    <li>
                        <h3 className="hover:underline">Discord</h3>
                    </li>
                </ul>
            </div>
            <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400">
                    ...
                    <li>
                        <h3 className="hover:underline">Terms &amp; Conditions</h3>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <h3 className="hover:underline">PawSome™</h3>. All Rights Reserved.
        </span>
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <h3 className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
